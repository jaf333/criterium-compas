...
export const SettingsLegalDpaNew = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await downloadFile(
        result.downloadUrl,
        `CRITERIUM-COMPAS-DPA-${result.agreement.templateVersion}-${safeLegalEntityName}.pdf`,
      );
      ...
      <SettingsPageContainer>
        ...
        <Section>
          <H2Title
            ...
            description={t`The PDF is pre-signed by CRITERIUM COMPÁS and executed with your legal entity and authorized signatory.`}
          />
          <SettingsTextInput
